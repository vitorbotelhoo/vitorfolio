...
export default function NeutralCard({
  Tagline,
  Headline,
  Date,
  Desc,
      ...
      <div
        ...
        <div
          ...
          className="flex flex-col w-full gap-[8px]">
            ...
            <p
              className="line-clamp-2 hover:line-clamp-none h-[40px] hover:h-fit w-full
        ...
        <div
          ...
          >
          <img
            className="rounded-[12px] bg-slate-500/50 h-[200px] w-[240px] object-cover"
            src={ImagemUm}
            draggable="false"
          ...
          {ImagemDois && (
            <img
              className="w-[90%] rounded-lg bg-slate-900 max-h-80 object-cover"
              src={ImagemDois}
              draggable="false"
